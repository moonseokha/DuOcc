...
from projects.mmdet3d_plugin.core.hook.sequentialcontrol import SequentialControlHook
...
def custom_train_detector(
    ...
    if "skip_prob" in cfg.data_basic_config:
        skip_prob = cfg.data_basic_config.skip_prob
        sequence_flip_prob = cfg.data_basic_config.sequence_flip_prob
    else:
        skip_prob = 0.0
    ...
    if cfg.get("custom_hooks", None):
        ...
        for hook_cfg in cfg.custom_hooks:
            ...
            if hook_cfg["type"] == "SequentialControlHook":
                hook = SequentialControlHook(
                    temporal_start_iter=hook_cfg.pop("temporal_start_iter", 1)
                )
