...
class MEGVIIEMAHook_OCC(Hook):
    ...
    def __init__(self, init_updates=0, decay=0.9990, split_iter=10548, resume=None):
        super().__init__()
    ...
    def before_run(self, runner):
        ...
        runner.ema_model = ModelEMA_OCC(runner.model, self.decay)
    ...
    def save_checkpoint(self, runner):
        ...
        save_path = f'iter_{runner.iter+1}_ema.pth'
