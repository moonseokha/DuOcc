...
def get_kmeans_anchor(
    ...
    gt_boxes = np.concatenate([x["gt_boxes_ego"] for x in data["infos"]], axis=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--detection_range", type=float, default=42)
    parser.add_argument(
        "--output_file_name", type=str, default="nuscenes_kmeans900_42m.npy"
    )
